 ...
 * Error types
 */
export class PageVisualizerError extends Error {
  constructor(
    message: string,
    public code: string,
    ...
    super(message);
    this.name = 'PageVisualizerError';
  }
}

export class ValidationError extends PageVisualizerError {
...
export class RenderingError extends PageVisualizerError {
  constructor(message: string, details?: unknown) {
...
export class AssetLoadError extends PageVisualizerError {
  constructor(message: string, details?: unknown) {
    super(message, 'ASSET_LOAD_ERROR', details);
